...
import bad_event_2 from './bad_event_2.png';

const { width: WIDTH } = Dimensions.get('window')
class bad_event_page_2 extends Component {
        ...
        return (
            <ImageBackground source={this.state.image[this.state.imagepage]} style={styles.backgroundContainer}>
                ...
                <View style={styles.Header}>
                    <Image source={bad_event_2} style={{ opacity: 0 }} />
...
export default bad_event_page_2;
