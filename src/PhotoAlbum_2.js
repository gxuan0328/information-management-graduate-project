...
class PhotoAlbum_2 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      spacebutton: {
  ...
  Enterphotocall = () => {
    ...
    imagedataVerify = this.readValue('response_uri_2')
  ...
  readValue = async () => {
    try {
      const jsonValue = await AsyncStorage.getItem('response_uri_2')
    ...
    launchCamera({
      ...
      (response) => {
        try {
          ...
          this.storeData('response_uri_2', response.assets[0].uri)
        } catch (e) {
          console.log('拍照失敗')
        }
      })
      ...
      <ImageBackground source={BGImage} style={styles.backgroundContainer}>
        ...
        <View style={styles.main}>
          ...
          <View style={styles.photo}>
            ...
            <Image style={styles.photo} source={require('../img/PhotoAblum2.png')} />
        ...
        <View style={styles.footer}>
          ...
          <View style={styles.back} >
            <TouchableOpacity
              onPress={() => { this.props.navigation.navigate('PhotoAlbum_3') }}>
