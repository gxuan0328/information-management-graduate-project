...
class PhotoAlbum_3 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      spacebutton: {
  ...
  Enterphotocall = () => {
    ...
    imagedataVerify = this.readValue('response_uri_3')
  ...
  readValue = async () => {
    try {
      const jsonValue = await AsyncStorage.getItem('response_uri_3')
    ...
    launchCamera({
      ...
      (response) => {
        try {
          ...
          this.storeData('response_uri_3', response.assets[0].uri)
        } catch (e) {
      ...
      <ImageBackground source={BGImage} style={styles.backgroundContainer}>
        ...
        <View style={styles.main}>
          ...
          <View style={styles.photo}>
            ...
            <Image style={styles.photo} source={require('../img/PhotoAblum3.png')} />
